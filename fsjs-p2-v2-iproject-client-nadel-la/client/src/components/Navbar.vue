        ...
        <div class="flex items-center justify-between py-4">
          <div>
            <svg
              ...
              class="w-10 h-10 text-black-600"
              viewBox="0 0 24 24"
            >
              <path
                fill="currentColor"
          ...
          <div class="hidden sm:flex text-center">
            <RouterLink to="/" class="text-gray-800 text-l font-semibold hover:text-purple-600 mr-4"
              >Home</RouterLink
            >
            <RouterLink
              to="/mentors"
              class="text-gray-800 text-l font-semibold hover:text-purple-600 mr-4"
              >Mentors</RouterLink
            >
            <RouterLink
              to="/wishlist"
          ...
          <div class="hidden sm:flex sm:items-center">
            <a
              ...
              @click="doLogout"
              href="#"
              class="text-gray-800 text-sm font-semibold px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600"
              >Logout</a
            >
            <RouterLink
              v-if="isLogin === false"
